...
# 上面方法参数feature_names=...是因为我们填入的时候是0，1，现在要还原成age, income等string

# 以上就生成了决策树保存在dot文件里，这个文件默认word打开以后还不是很直观，需要用我们安装的graphviz将dot转成pdf
# terminal: dot -Tpdf allElectronicsInformationGainOri.dot -o decistionTreeOutput.pdf
